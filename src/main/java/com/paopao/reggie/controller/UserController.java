...
import com.paopao.reggie.utils.ValidateCodeUtils;
...
public class UserController {
    ...
    public R<String> sendMsg(@RequestBody User user, HttpSession session){
        ...
        log.info("session:{}",session.getAttribute("phone").toString());

        return R.error("手机验证短信发送失败");
    }
    /**
     * 移动用户端登录
     * @param map
    ...
    public R<User> login(@RequestBody Map map, HttpSession session){
        ...
        //进行验证码比对（页面提交的验证码和session中保存的验证码对比
